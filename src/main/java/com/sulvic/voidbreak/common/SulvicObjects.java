...
//	public static final BlockSpecialWorkbench SPECIAL_WORKBENCH = new BlockSpecialWorkbench();
	...
	public static void registerItems(){
		...
		GameRegistry.registerBlock(CITRUS_DOUBLE_SLAB, ItemSlabCitrus.class, "citrus_slab_double", CITRUS_SLAB, CITRUS_DOUBLE_SLAB, false);
...
//		GameRegistry.registerTileEntity(TileSpecialWorkbench.class, "SpecialWorkbench");
	...
	public static void registerBiomes(){
		BiomeDictionary.registerBiomeType(FLATLANDS, SPARSE, WET, LUSH, PLAINS);
		BiomeManager.addBiome(BiomeManager.BiomeType.WARM, new BiomeManager.BiomeEntry(FLATLANDS, 8));
