...
//    public static VoidBreakDemo2 instance;
    ...
    public VoidBreakDemo2() {
        this.masterHandler = new EventsVBD2();
    }
    ...
    public void preInit(final FMLPreInitializationEvent event) {
        ...
        FMLCommonHandler.instance().bus().register((Object)this.masterHandler);
        MinecraftForge.EVENT_BUS.register((Object)this.masterHandler);
