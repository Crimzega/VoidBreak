...
public class NetherGenMinable extends WorldGenerator{
	...
	public NetherGenMinable(Block block, int numb){ this(block, numb, Blocks.netherrack); }

	public NetherGenMinable(Block block, int numb, Block block2){
		field_150519_a = block;
		numberOfBlocks = numb;
		field_150518_c = block2;
	}

	public NetherGenMinable(Block block, int number, int meta, Block target){
			...
			for(int k2 = i1; k2 <= l2; ++k2) {
				...
				if(d13 * d13 < 1d) {
					for(int l3 = j1; l3 <= i2; ++l3) {
						double d14 = (l3 + 0.5d - d8) / (d12 / 2d);
						if(d13 * d13 + d14 * d14 < 1d) {
							for(int i3 = k1; i3 <= j2; ++i3) {
								double d15 = (i3 + 0.5d - d9) / (d11 / 2d);
								if(d13 * d13 + d14 * d14 + d15 * d15 < 1d && world.getBlock(k2, l3, i3).isReplaceableOreGen(world, k2, l3, i3, field_150518_c))
									world.setBlock(k2, l3, i3, field_150519_a, mineableBlockMeta, 2);
							}
						}
					}
				}
