...
public class ContentsVBD2
{
    ...
    static {
        ContentsVBD2.basics = new String[][] { { "TT", "TT" }, { "TTT", "TTT", "TTT" }, { "TTT", "TPT", "TTT" }, { "TTT", "T T", "TTT" }, { "T", "T" }, { "T T", " T " } };
        ContentsVBD2.armor = new String[][] { { "TTT", "T T" }, { "T T", "TTT", "TTT" }, { "TTT", "T T", "T T" }, { "T T", "T T" } };
        ContentsVBD2.tools = new String[][] { { "T", "T", "P" }, { "T", "P", "P" }, { "TTT", " P ", " P " }, { "TT", "TP", " P" }, { "TT", " P", " P" } };
    }
}
